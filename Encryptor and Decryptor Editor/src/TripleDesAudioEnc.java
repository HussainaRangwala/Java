...
public class TripleDesAudioEnc{
// Default length with Default 128
    ...
    public TripleDesAudioEnc(String input_file,String enc_file,SecretKey key,AlgorithmParameterSpec paramSpec) 
    {
    	try{
    	 byte[] keyData = key.getEncoded();
         TripleDesAudioEnc.encrypt(key, paramSpec, new FileInputStream(input_file), new FileOutputStream(enc_file));
    	}
