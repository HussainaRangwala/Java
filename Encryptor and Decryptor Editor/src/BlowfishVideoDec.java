...
public class BlowfishVideoDec {
    ...
    private final static String ALGO_VIDEO_ENCRYPTOR = "Blowfish/CBC/PKCS5Padding";

    public BlowfishVideoDec(String input_file,String dec_file,SecretKey key,AlgorithmParameterSpec paramSpec) throws Exception
    {
        ...
        System.out.println("ip file: "+input_file+"  "+paramSpec);
        System.out.println(key2);
        BlowfishVideoDec.decrypt(key2, paramSpec, new FileInputStream(input_file), new FileOutputStream(dec_file));
