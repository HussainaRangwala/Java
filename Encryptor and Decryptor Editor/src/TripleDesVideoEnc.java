...
public class TripleDesVideoEnc{
// Default length with Default 128
    ...
    public TripleDesVideoEnc(String input_file,String enc_file,SecretKey key,AlgorithmParameterSpec paramSpec) 
    {
    	try{
    	 byte[] keyData = key.getEncoded();
         TripleDesVideoEnc.encrypt(key, paramSpec, new FileInputStream(input_file), new FileOutputStream(enc_file));
    	}
