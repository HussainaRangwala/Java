...
public class DesAudioDec {
    private final static int DEFAULT_READ_WRITE_BLOCK_BUFFER_SIZE = 1024;

    private final static String ALGO_SECRET_KEY_GENERATOR = "DES";
    private final static String ALGO_AUDIO_ENCRYPTOR = "DES/CBC/PKCS5Padding";

    public DesAudioDec(String input_file,String dec_file,SecretKey key,AlgorithmParameterSpec paramSpec) throws Exception
    {
        ...
        DesAudioDec.decrypt(key2, paramSpec, new FileInputStream(input_file), new FileOutputStream(dec_file));
