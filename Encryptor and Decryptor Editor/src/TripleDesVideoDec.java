...
public class TripleDesVideoDec {
    ...
    private final static String ALGO_VIDEO_ENCRYPTOR = "DESede/CBC/PKCS5Padding";

    public TripleDesVideoDec(String input_file,String dec_file,SecretKey key,AlgorithmParameterSpec paramSpec) throws Exception
    {
        ...
        TripleDesVideoDec.decrypt(key2, paramSpec, new FileInputStream(input_file), new FileOutputStream(dec_file));
