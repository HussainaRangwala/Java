...
public class DesVideoDec {
    ...
    private final static String ALGO_VIDEO_ENCRYPTOR = "DES/CBC/PKCS5Padding";

    public DesVideoDec(String input_file,String dec_file,SecretKey key,AlgorithmParameterSpec paramSpec) throws Exception
    {
        ...
        DesVideoDec.decrypt(key2, paramSpec, new FileInputStream(input_file), new FileOutputStream(dec_file));
